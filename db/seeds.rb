...
tr0 = NeoEdge.create(title: "r0", text: "from 0 to 1", you_need: " not yet implemented  ", you_get: " not yet implemented ", from_node: tn0, to_node: tn1 )
tr1 = NeoEdge.create(title: "r1", text: "from 0 to 2", you_need: " not yet implemented  ", you_get: " not yet implemented  ", from_node: tn0, to_node: tn2 )
tr2 = NeoEdge.create(title: "r2", text: "from 1 to 3", you_need: " not yet implemented  ", you_get: " not yet implemented  ", from_node: tn1, to_node: tn3 )
tr3 = NeoEdge.create(title: "r3", text: "from 2 to 3", you_need: " not yet implemented  ", you_get: " not yet implemented  ", from_node: tn2, to_node: tn3 )
tr4 = NeoEdge.create(title: "r4", text: "from 2 to 1", you_need: " not yet implemented  ", you_get: " not yet implemented  ", from_node: tn2, to_node: tn1 )
